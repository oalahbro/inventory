                        ...
                        <div class="details-product">
                            <div class="details-thumd">
                                <div class="image-preview-container image-thick-box image_preview_container">
                                    <img id="img_zoom" data-zoom-image="assets/images/item/<?= $new['image1'] ?>" src="assets/images/item/<?= $new['image1'] ?>" alt="img">
                                ...
                                <div class="product-preview image-small product_preview">
                                    <div id="thumbnails" class="thumbnails_carousel owl-carousel" data-nav="true" data-autoplay="false" data-dots="false" data-loop="false" data-margin="10" data-responsive='{"0":{"items":3},"480":{"items":3},"600":{"items":3},"1000":{"items":3}}'>
                                        <a href="#" data-image="assets/images/item/<?= $new['image1'] ?>" data-zoom-image="assets/images/item/<?= $new['image1'] ?>" class="active">
                                            <img src="assets/images/item/<?= $new['image1'] ?>" data-large-image="assets/images/item/<?= $new['image1'] ?>" alt="img">
                                        </a>
                                        <a href="#" data-image="assets/images/item/<?= $new['image2'] ?>" data-zoom-image="assets/images/item/<?= $new['image2'] ?>">
                                            <img src="assets/images/item/<?= $new['image2'] ?>" data-large-image="assets/images/item/<?= $new['image2'] ?>" alt="img">
                                        </a>
                                        <a href="#" data-image="assets/images/item/<?= $new['image3'] ?>" data-zoom-image="assets/images/item/<?= $new['image3'] ?>">
                                            <img src="assets/images/item/<?= $new['image3'] ?>" data-large-image="assets/images/item/<?= $new['image3'] ?>" alt="img">
                                        </a>
                                        <a href="#" data-image="assets/images/item/<?= $new['image4'] ?>" data-zoom-image="assets/images/item/<?= $new['image4'] ?>">
                                            <img src="assets/images/item/<?= $new['image4'] ?>" data-large-image="assets/images/item/<?= $new['image4'] ?>" alt="img">
                                        </a>
                                    </div>
                                </div>
                            </div>
