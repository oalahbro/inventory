<body class="about-page">
    <div class="main-content main-content-about">
        <div class="container">
            ...
            <form method="post" action="<?= base_url() ?>home/tentang">
                <div class="row">
                    <div class="content-area content-about col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="site-main">
                            ...
                            <div class="page-main-content">
                                ...
                                <div class="team-member" style="margin-top: 10%;">
                                    <h2 class="custom_blog_title center">
                                        Lokasi
                                    </h2>
                                    <!--Google map-->
                                    <div id="map-container-google-1" class="z-depth-1-half map-container" style="height: 500px">
                                        <iframe src="https://maps.google.com/maps?q=SMAN+1+Barat+Magetan&t=&z=13&ie=UTF8&iwloc=&output=embed" style="border-radius: 8px; top:0; left:0; bottom:0; right:0; width:100%; height:100%; border:none; margin:0; padding:0; overflow:hidden; z-index:999999;"></iframe>
                                    </div>
                                </div>
                            </div>
                        </div>
