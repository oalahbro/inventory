<div class="content-body">
    ...
    <div class="container-fluid">
        ...
        <div class="form-head align-items-center d-flex mb-sm-4 mb-3">
            ...
            <form class="input-group mb-3 col-md-8" method="POST" action="<?= base_url() ?>superadmin/searchInventory">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" class="form-control" name="tahun" placeholder="2017-06-04" id="mdate" required>
                                    </div>
